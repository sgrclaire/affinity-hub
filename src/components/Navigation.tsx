      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            <img src={logo} alt="Affinity Logo" className="h-10 w-auto transition-transform group-hover:scale-105" />
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              to="/profiles"
              className={`text-sm font-display transition-colors ${
                isActive("/profiles") ? "text-foreground font-semibold" : "text-muted-foreground hover:text-foreground"
              }`}
            >
              Profils
            </Link>
